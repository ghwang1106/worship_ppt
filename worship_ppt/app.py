...
from .jubo2pptx import make_main_ppt
from .hymn2pptx import make_hymn_ppt
...
def create_app():
  ...
  def download_obs():
    if request.method == "POST":
      ppt_inputs = [
          request.form['date_type'], request.form['sermon_title'], request.form['preacher'],
          request.form['main_passage'], request.form['quotes']
      ]
