# Python program to write text on video
...
class Video():
  ...
  def add_text(self, txt, x, y, tfrom, tto=None, ft=42, c=[255, 255, 255], center=0):
    ...
    font = ImageFont.truetype(DATA_PATH / "malgun.ttf", ft)
  ...
  def add_audio(self, path, audio_file=DATA_PATH / 'intro_music.mp3'):
...
def make_intro_vid(ppt_inputs):
  ...
  intro = Video(DATA_PATH / 'template.mp4')
  ...
  file_name = DATA_PATH + (re.sub("\D+", "_", sermon.date_type) + '인트로')
